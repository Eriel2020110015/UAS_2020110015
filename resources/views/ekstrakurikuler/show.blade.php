            ...
            <div class="col-md-8">
                <div class="card shadow-lg rounded-4">
                    <div class="card-header text-center bg-gradient-primary text-white">
                        <h3 class="display-5">Detail Ekstrakurikuler</h3>
                    </div>
                    <div class="card-body">
                        <!-- Card Content -->
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                <div class="p-4 border rounded-3 bg-light shadow-sm">
                                    <h4><i class="fas fa-cogs"></i> Nama Ekstrakurikuler</h4>
                                    <p class="fs-5 text-muted">{{ $ekskul->nama_ekskul }}</p>
                                </div>
                            </div>
                            <div class="col-md-6 mb-4">
                                <div class="p-4 border rounded-3 bg-light shadow-sm">
                                    <h4><i class="fas fa-chalkboard-teacher"></i> Pembina</h4>
                                    <p class="fs-5 text-muted">{{ $ekskul->pembina }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="text-center mt-4">
                            <a href="{{ route('ekstrakurikuler.index') }}"
                                class="btn btn-lg btn-gradient-primary shadow-md">
