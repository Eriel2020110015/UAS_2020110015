...
@section('content')
    <div class="container">
        <h2>Edit Nilai Pelajaran</h2>
        <form action="{{ route('nilai_pelajaran.update', $nilaiPelajaran->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="mb-3">
                ...
                <select name="siswa_id" id="siswa_id" class="form-control @error('siswa_id') is-invalid @enderror">
                    ...
                    @foreach ($siswas as $siswa)
                        <option value="{{ $siswa->id }}" {{ $siswa->id == $nilaiPelajaran->siswa_id ? 'selected' : '' }}>
                            {{ $siswa->nama }}</option>
                    @endforeach
                </select>
                @error('siswa_id')
                ...
                <select name="mata_pelajaran_id" id="mata_pelajaran_id"
                    ...
                    @foreach ($mataPelajarans as $mataPelajaran)
                        <option value="{{ $mataPelajaran->id }}"
                            {{ $mataPelajaran->id == $nilaiPelajaran->mata_pelajaran_id ? 'selected' : '' }}>
            ...
            <div class="mb-3">
                ...
                <input type="number" name="nilai_tugas" id="nilai_tugas"
                    ...
                    value="{{ old('nilai_tugas', $nilaiPelajaran->nilai_tugas) }}" min="0" max="100">
                @error('nilai_tugas')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" name="nilai_ulangan" id="nilai_ulangan"
                    ...
                    value="{{ old('nilai_ulangan', $nilaiPelajaran->nilai_ulangan) }}" min="0" max="100">
                @error('nilai_ulangan')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" name="nilai_uts" id="nilai_uts"
                    ...
                    value="{{ old('nilai_uts', $nilaiPelajaran->nilai_uts) }}" min="0" max="100">
                @error('nilai_uts')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" name="nilai_uas" id="nilai_uas"
                    ...
                    value="{{ old('nilai_uas', $nilaiPelajaran->nilai_uas) }}" min="0" max="100">
                @error('nilai_uas')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" name="nilai_keterampilan" id="nilai_keterampilan"
                    ...
                    value="{{ old('nilai_keterampilan', $nilaiPelajaran->nilai_keterampilan) }}" min="0"
                    max="100">
