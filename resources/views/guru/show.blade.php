            ...
            <div class="col-md-8">
                <div class="card shadow-lg rounded-4">
                    <div class="card-header text-center bg-gradient-primary text-white">
                        <h3 class="display-5">Detail Guru</h3>
                    </div>
                    <div class="card-body">
                        <!-- Card Content -->
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                <div class="p-4 border rounded-3 bg-light shadow-sm">
                                    <h4><i class="fas fa-cogs"></i> Kode Guru</h4>
                                    <p class="fs-5 text-muted">{{ $guru->kode_guru }}</p>
                                </div>
                            </div>
                            <div class="col-md-6 mb-4">
                                <div class="p-4 border rounded-3 bg-light shadow-sm">
                                    <h4><i class="fas fa-user"></i> Nama Guru</h4>
                                    <p class="fs-5 text-muted">{{ $guru->nama_guru }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                <div class="p-4 border rounded-3 bg-light shadow-sm">
                                    <h4><i class="fas fa-briefcase"></i> Jabatan</h4>
                                    <p class="fs-5 text-muted">{{ $guru->jabatan }}</p>
                                </div>
                            </div>
                            <div class="col-md-6 mb-4">
                                <div class="p-4 border rounded-3 bg-light shadow-sm">
                                    <h4><i class="fas fa-book"></i> Mata Pelajaran</h4>
                                    <p class="fs-5 text-muted">{{ $guru->mata_pelajaran }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="text-center mt-4">
                            <a href="{{ route('guru.index') }}" class="btn btn-lg btn-gradient-primary shadow-md">
